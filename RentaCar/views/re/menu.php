                        ...
                        <div id="logo_normal" class="logo_container">
                            <div class="logo_align">
                                <a id="custom_logo" class="logo_wrapper hidden" href="index.php">
                                    <img src="images/logo2.png" alt="" width="175" height="24" />
                                </a>
                            </div>
                        </div>
                                    ...
                                    <div id="menu_border_wrapper">
                                        <div class="menu-main-menu-container">
                                            <ul id="main_menu" class="nav">
                                                ...
                                                <li class=""><a href="autosDisp.php">Autos Disponibles</a> </li>
                                                <li class=""><a href="masparati.php">Más para ti</a></li>
                                                <li class=""><a href="sobreNos.php">Sobre Nosotros</a></li>
