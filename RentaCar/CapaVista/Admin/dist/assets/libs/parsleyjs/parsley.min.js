	...
	e.extend(!0, T, {
		...
		T.addMessages("en", {
			...
			type: {
				...
				url: "Debe ingresar url válida.",
				number: "Debe ingresar un número válido.",
				integer: "This value should be a valid integer.",
				digits: "This value should be digits.",
				alphanum: "This value should be alphanumeric.",
			},
			notblank: "Este campo no debe quedar vacío.",
			required: "Este campo es requerrido.",
			pattern: "This value seems to be invalid.",
			min: "Número mínimo %s.",
			max: "Número máximo %s.",
			range: "Debe ingresar un número entre %s y %s.",
			minlength: "Este campo debe tener más de %s carácteres.",
			maxlength: "Este campo debe tener menos de %s carácteres.",
			length: "Valor inválido, debe ingresar entre %s y %s carácteres.",
